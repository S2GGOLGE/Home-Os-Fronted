const HUB_BASE = getApiBaseUrl().replace(/\/api$/i, '');
...
async function fetchDashboardStats() {
    try {
        const stats = await SystemLogsEndpoint.getDashboardStats();
...
async function fetchSystemLogs() {
    ...
    try {
        ...
        const result = await SystemLogsEndpoint.list(params);
...
async function fetchDevices() {
    ...
    try {
        const devices = await SystemLogsEndpoint.getDevices();
...
async function fetchUsers() {
    ...
    try {
        const users = await SystemLogsEndpoint.getUsers();
...
async function fetchCommands() {
    ...
    try {
        const commands = await SystemLogsEndpoint.getCommands();
